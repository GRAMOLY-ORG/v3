    ...
    <>
      ...
      >
        <div className="flex flex-col gap-y-3 md:justify-start md:relative ">
          ...
          <p className="text-darkblue opacity-80 text-center md:text-left text-sm md:w-[400px] lg:text-lg lg:w-[600px]">
          GRAM is collective of curious and innovative students who strive to make an impact in the field of education, and change the system for the better by helping young minds explore various STEM fields. We dream of building a community of all those have a shared love for sciences, and rally for this cause.
          </p>
          <div className="flex flex-col md:flex-row gap-2 text-sm lg:text-lg text-darkblue self-center md:self-start">
